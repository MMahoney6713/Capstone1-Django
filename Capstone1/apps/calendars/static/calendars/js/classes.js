...
class Goal {
    ...
    HTML() {
        return $(`
        <div class="card mb-2" data-id="${this.id}">
            <div class="card-header py-2 bg-secondary d-flex justify-content-between">
                <h6 class="m-0 font-weight-bold text-light">${this.title}</h6>
                <div class="m-0 p-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="white" class="bi bi-pencil-fill" viewBox="0 0 16 16">
